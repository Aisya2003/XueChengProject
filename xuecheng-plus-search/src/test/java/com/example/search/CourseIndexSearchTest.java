...
public class CourseIndexSearchTest {
    ...
    @Autowired
    IIndexService courseIIndexService;
    ...
    public void test_addindex() {
        ...
        Boolean result = courseIIndexService.addCourseIndex(courseIndexStore, "101", courseIndex);
    ...
    public void test_updateIndex() {
        ...
        Boolean result = courseIIndexService.updateCourseIndex(courseIndexStore, "101", courseIndex);
        System.out.println(result);
